...
def evaluation_function(func):
    def evaluation_wrapper(correction_fitter, prediction_fitter, observations, correctors=None,
                           correction_parameters=None, predictors=None, prediction_parameters=None, *args, **kwargs):
...
@evaluation_function
def mse(correction_fitter, prediction_fitter, observations, correctors, correction_parameters, predictors,
...
@evaluation_function
def r2(correction_fitter, prediction_fitter, observations, correctors, correction_parameters, predictors,
       prediction_parameters):
    '''Evaluates the significance of the predictors as regards the behaviour of the observations by computing
...
@evaluation_function
def fstat(correction_fitter, prediction_fitter, observations, correctors, correction_parameters, predictors,
          prediction_parameters):
    """Evaluates the significance of the predictors as regards the behaviour of the observations by computing
...
@evaluation_function
def ftest(correction_fitter, prediction_fitter, observations, correctors, correction_parameters, predictors,
          prediction_parameters):
    ...
    f_score = fstat(correction_fitter, prediction_fitter, observations, correctors, correction_parameters, predictors,
                    prediction_parameters)
...
@evaluation_function
def aic(correction_fitter, prediction_fitter, observations, correctors, correction_parameters, predictors,
        prediction_parameters):
    """Evaluates the significance of the predictors as regards the behaviour of the observations by computing
        the Akaike Information Criterion (AIC).
    """
    k = correction_parameters.shape[0] + prediction_parameters.shape[
        0] + 1  # the residual error counts as an estimated variable
    n = observations.shape[0]
...
@evaluation_function
def aicc(correction_fitter, prediction_fitter, observations, correctors, correction_parameters, predictors,
         prediction_parameters):
    """Evaluates the significance of the predictors as regards the behaviour of the observations by computing
    ...
    return aic(correction_fitter, prediction_fitter, observations, correctors, correction_parameters, predictors,
               prediction_parameters) + 2 * k * (k + 1) / np.float64(n - k - 1)
