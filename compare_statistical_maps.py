...
if __name__ == '__main__':
    ...
    arguments_parser = ArgumentParser(description='Compares statistical maps generated by '
                                                  ' compute_statistical_maps.py using two possible techniques:'
                                                  ' RGB map, or best-fitting map. You must specify the'
                                                  ' specific maps to compare and ensure that their are'
                                                  ' comparable (Z-score map vs Z-score map, p-value map vs '
                                                  ' p-value map, etc.)')
    ...
    if method == 'best':
        ...
        print('Storing comparison maps...')
        rgb_name = '{}-rbg.nii.gz'.format(name) if name else 'rbg.nii.gz'
        rgb_mask_name = '{}-rgb_mask.nii.gz'.format(name) if name else 'rbg_mask.nii.gz'
