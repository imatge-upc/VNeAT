...
print 'Mean energy of the difference (GLM - PGLM) in corrected data:', sum(
    (corrected_pdata - corrected_data) ** 2) / len(corrected_data)
print 'Mean energy of the difference (GLM - PGLM) in predicted data:', sum((prediction - pprediction) ** 2) / len(
    prediction)
