...
from vneat.Visualization.GUIVisualizer import GUIVisualizer_latent
...
if __name__ == '__main__':
    ...
    """ INIT VISUALIZER """
    visualizer = GUIVisualizer_latent(template=template, affine=affine_matrix, predictor_names=predictors_names,
                                      num_points=n_points)
