...
gamp = GAMP(subjects, regressors=[Subject.ADCSFIndex], user_defined_parameters=user_defined_parameters,
            correctors=[Subject.Age, Subject.Sex])
...
while True:
    ...
    try:
        # PolyGLM Curve
        corrected_data = pglmp.corrected_values(pglm_correction_parameters, x1=x, x2=x + 1, y1=y, y2=y + 1, z1=z,
                                                z2=z + 1)
        ...
        axis, curve = pglmp.curve(pglm_regression_parameters, x1=x, x2=x + 1, y1=y, y2=y + 1, z1=z, z2=z + 1,
                                  tpoints=50)
        ...
        # GAM Curve
        corrected_data = gamp.corrected_values(gam_correction_parameters, x1=x, x2=x + 1, y1=y, y2=y + 1, z1=z,
                                               z2=z + 1)
        ...
        # Poly SVR Curve
        corrected_data = psvr.corrected_values(psvr_correction_parameters, x1=x, x2=x + 1, y1=y, y2=y + 1, z1=z,
                                               z2=z + 1)
