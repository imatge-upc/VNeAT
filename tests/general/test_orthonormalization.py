...
print '    Maximum difference between the original and the denormalized matrices:', np.abs(
    old_features - features).max()
print
...
print '    Maximum difference between the original and the deorthogonalized matrices:', np.abs(
    old_features - features).max()
print
...
print '    Maximum difference between the original and the deorthonormalized matrices:', np.abs(
    old_features - features).max()
print
